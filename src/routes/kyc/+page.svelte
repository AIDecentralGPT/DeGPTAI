...
<div class="w-full flex flex-col">
  <div class="flex flex-col items-center w-full mt-8">
    <img class="w-[200px]" src="./kyc/faceError.png" alt="icon"/>
  ...
  <div class="flex flex-col mt-6 m-2 bg-gray-100 p-4 rounded-md">
    ...
    <div class="flex flex-row items-center mt-2">
      <img class="size-8" src="./kyc/copytip.png" alt=""/>
      <span class="text-sm ml-2">{$i18n.t("Click \"Copy Link\".")}</span>
    </div>
    <div class="flex flex-row items-center mt-2">
      <img class="size-8" src="./kyc/browser.png" alt=""/>
