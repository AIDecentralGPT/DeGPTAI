...
> -->
  ...
  <div id="wallet-view" class="min-w-[300px] max-w-[320px] absolute bottom-1 left-0 dark:bg-black bg-white pb-2 rounded border-gray-800 transition ease-in-out delay-1500 {showWalletView ? 'scale-100' : 'hidden scale-0'}"
    style="border-width: 1px;"
    on:mouseover={showWallet}
    on:mouseleave={closeWallet}>
    <!-- 社媒 -->
    <SocialMedia />
    <!-- 钱包 -->
    <Wallet />
