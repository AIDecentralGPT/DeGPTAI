                ...
                <div class="flex flex-row">
                  ...
                  <div class="self-star mb-2 ml-1 mr-1">
                    <Tooltip content={$i18n.t("Search the web")}>
                      <button class="flex flex-row items-center text-gray-800 dark:text-white transition rounded-full pr-3 cursor-pointer ease-in-out duration-300
                        {(!search_icon_show && search) ? 'bg-black' : 'bg-gray-50 dark:bg-gray-800'}"
                        type="button"
                        ...
                        <button class="flex flex-row pl-2 pr-1 py-2 rounded-full {search? 'bg-black' : ''}"
                          type="button"
                        ...
                        <div class="flex flex-row py-1 ease-in-out duration-300 {(search_icon_show && search) ? 'px-1' : ''}">
