    ...
    <div class="max-h-[80dvh] xs:h-auto flex flex-col">
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8 flex-1 overflow-auto">
        <div class="mx-auto max-w-4xl text-center">
          <h2 class="font-semibold leading-7 primaryText text-2xl">{$i18n.t('Pricing')}</h2>
        </div>
        ...
        <div class="isolate mx-auto grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2 h-8/10 md:h-108 overflow-y-auto">
          <div class="rounded-3xl p-8 ring-1 xl:p-10 ring-gray-200 m-4">
            <h3 id="tier-free" class="text-lg font-semibold leading-8">{$i18n.t('Free')}</h3>
            ...
            <p class="text-sm leading-6 text-gray-400">{$i18n.t('per user, billed monthly')}</p>
            <button
              disabled
          ...
          <div class="rounded-3xl p-8 ring-1 xl:p-10 ring-gray-200 m-4">
            <h3 id="tier-plus" class="text-lg font-semibold leading-8">{$i18n.t('Plus')}</h3>
            <p class="mt-6 flex items-baseline gap-x-1">
            ...
            <button 
              ...
              href="#" aria-describedby="tier-plus" class="mt-6 px-4 py-2 primaryButton text-gray-100 text-sm transition rounded-lg w-full"
            >
