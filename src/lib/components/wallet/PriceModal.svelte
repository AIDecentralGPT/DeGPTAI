<script lang="ts">
  ...
  import { user, showConfirmUpgradeModal, vipupgrade, currentWalletData, dgcRate } from '$lib/stores';
        ...
        if (item?.show) {
          if (item?.time == 'month') {
            if (item?.use / item?.total > 0.9) {
              html =
                "<div><span class='text-red-900 font-bold'>" +
                item?.use +
                '</span>' +
...
<Modal bind:show size="big">
  <div class="max-h-[80vh] xs:h-auto flex flex-col">
    ...
    <div class="mx-4 px-2 flex-1 overflow-auto">
      ...
      <div class="flex flex-gird flex-wrap justify-center h-8/10 md:h-108 overflow-y-auto pb-4 mt-4">
        <div class="rounded-3xl p-4 ring-1 min-w-[337px] max-w-[376px] ring-gray-200 m-4">
          ...
          <div class="flex justify-center mt-2">
            {#if userTotal?.free_total?.show}
              <span
                class={userTotal?.free_total?.use / userTotal?.free_total?.total > 0.9
                  ? 'text-red-900 font-bold'
                  : 'text-green-900'}>{userTotal?.free_total?.use}</span
              >
              <span
                class="mx-0.5 {userTotal?.free_total?.use / userTotal?.free_total?.total > 0.9
                  ? 'text-red-900'
                  : 'text-green-900'}">/</span
              >
          ...
          <ul role="list" class="mt-8 space-y-3 text-sm leading-6 xl:mt-10 font-bold text-gray-600 dark:text-gray-300">
              ...
              <div>
                ...
                <div>
                  <div class="flex flex-row items-center mt-2">
                    <img class="w-[22px]" src="/icon/deepseek.png" alt="icon" />
                    <span class="text-base font-bold ml-2">DeepSeek V3.2</span>
                  </div>
                  <div class="flex flex-row items-center mt-2">
                    <img class="w-[22px]" src="/icon/doubao.png" alt="icon" />
                    <span class="text-base font-bold ml-2">DouBao 1.6 (TikTok)</span>
                  </div>
                  <div class="flex flex-row items-center mt-2">
                    <img class="w-[22px]" src="/icon/qwen.png" alt="icon" />
                  ...
                  <div class="flex flex-row items-center mt-2">
                    <img class="w-[24px]" src="/icon/gpt3.png" alt="icon" />
            ...
            <div class="flex flex-col mt-4">
              <div class="flex flex-row justify-start mb-2 ml-1">
                <div class="flex flex-row flex-wrap">
                  <span class="text-sm tracking-tight primaryText font-bold mr-1"
                    >$33 / {$i18n.t('Year')} ({$i18n.t('Instant Savings')} 8%)</span
                  >
                  <span class="text-sm tracking-tight font-bold primaryText mr-2"
                    >(={divideAndRound(33, $dgcRate.rate)}DGC)</span
                  >
                </div>
          ...
          <ul role="list" class="mt-8 space-y-3 text-sm leading-6 xl:mt-10 font-bold text-gray-600 dark:text-gray-300">
            ...
            <li class="flex gap-x-3">
              ...
              <div>
                ...
                <div>
                  <div class="flex flex-row items-center mt-2">
                    <img class="w-[22px]" src="/icon/gpt_round.png" alt="icon" />
                  ...
                  <div class="flex flex-row items-center mt-2">
                    <img class="w-[22px]" src="/icon/gemini.png" alt="icon" />
                    <span class="text-base font-bold ml-2">Gemini 2.5 Flash (Google)</span>
                  </div>
                  <div class="flex flex-row items-center mt-2">
                    <img class="w-[22px]" src="/icon/grok.png" alt="icon" />
            ...
            <li class="flex gap-x-3">
              ...
              <div>
                ...
                <div>
                  ...
                  <div class="flex flex-row items-center mt-2">
                    <img class="w-[22px]" src="/icon/claude.png" alt="icon" />
          ...
          {:else}
            <div class="flex flex-col mt-4">
              <div class="flex flex-row justify-start mb-2 ml-1">
                <div class="flex flex-row flex-wrap">
                  <span class="text-sm tracking-tight primaryText font-bold mr-1"
                    >$88 / {$i18n.t('Year')} ({$i18n.t('Instant Savings')} 8%)</span
                  >
                  <span class="text-sm tracking-tight font-bold primaryText mr-2"
                    >(={divideAndRound(88, $dgcRate.rate)}DGC)</span
                  >
                </div>
                <div class="flex-1 flex justify-start pt-1">
          ...
          {:else}
            <div class="flex flex-col mt-4">
              <div class="flex flex-row justify-start mb-2 ml-1">
                <div class="flex flex-row flex-wrap">
                  <span class="text-sm tracking-tight primaryText font-bold mr-1"
                    >$165 / {$i18n.t('Year')} ({$i18n.t('Instant Savings')} 9%)</span
                  >
                  <span class="text-sm tracking-tight font-bold primaryText mr-2"
                    >(={divideAndRound(165, $dgcRate.rate)}DGC)</span
                  >
                </div>
                <div class="flex-1 flex justify-start pt-1">
...
<ConfirmUpgradeModal
  ...
  bind:viptime
  bind:money
  bind:rate={$dgcRate.rate}
  bind:show={$showConfirmUpgradeModal}
/>
