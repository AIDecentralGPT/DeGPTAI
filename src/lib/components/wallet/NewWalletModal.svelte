          ...
          <div class="flex justify-between items-center my-4">
            ...
            {#if isMobile}
              <div class="flex flex-col">
                <button class="flex flex-row items-center rounded-full px-4 py-2 mb-3 bg-gray-700 dark:bg-white text-white dark:text-gray-900">
                ...
                <button class="flex flex-row items-center rounded-full px-4 py-2 bg-gray-700 dark:bg-white text-white dark:text-gray-900">
            ...
            <button
              disabled={loading}
              class=" px-4 py-2 primaryButton text-gray-100 transition rounded-lg max-h-[50px]"
