...
type LayoutRouteId = RouteId | "/(app)/workspace" | "/(app)/workspace/documents" | "/(app)/workspace/modelfiles" | "/(app)/workspace/modelfiles/create" | "/(app)/workspace/modelfiles/edit" | "/(app)/workspace/playground" | "/(app)/workspace/prompts" | "/(app)/workspace/prompts/create" | "/(app)/workspace/prompts/edit"
