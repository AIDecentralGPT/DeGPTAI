...
# y41BCjq6yck32Mw050vGkdMNO8nPqF
    ...
    def initialize(self, metaInfo: MetaInfo):
        ...
        request = cloudauth_models.InitializeRequest(
            ...
            return_url="http://43.242.202.166:3000/userVerifying?user_id=" + metaInfo['user_id'],
        ...
        print("initialize_response", response, "http://43.242.202.166:3000/userVerifying?user_id=" + metaInfo['user_id'])
        return response
