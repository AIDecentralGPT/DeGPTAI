...
class FaceCompare:
    ...
    def initialize(self, merchant_biz_id: str, merchant_user_id: str, meta_info: str, return_url: str, authorize: str, language_config: str, product_code: str):
        # 构建初始化请求
        request = cloudauth_models.InitializeRequest(
    ...
    def ekyc(self, source_face_base64: str, target_face_base64: str, merchant_biz_id: str, merchant_user_id: str, meta_info: str, return_url: str, authorize: str, language_config: str, product_code: str):
        # 执行初始化
        init_response = self.initialize(merchant_biz_id, merchant_user_id, meta_info, return_url, authorize, language_config, product_code)
        
        # 假设初始化成功，继续进行脸部对比
        compare_response = self.compare_faces(source_face_base64, target_face_base64)
    ...
    # # 执行eKYC流程
    # result = face_compare.ekyc(
    #     source_face_base64="source_face_base64_placeholder",  # 替换为实际值
    #     target_face_base64="target_face_base64_placeholder",  # 替换为实际值
    #     merchant_biz_id="merchant_biz_id_placeholder",        # 替换为实际值
    #     merchant_user_id="merchant_user_id_placeholder",      # 替换为实际值
    #     meta_info="meta_info_placeholder",                    # 替换为实际值
    #     return_url="return_url_placeholder",                  # 替换为实际值
    #     authorize="T",                                        # 替换为实际值
    #     language_config="language_config_placeholder",        # 替换为实际值
    #     product_code="eKYC"                                   # 替换为实际值
    # )
